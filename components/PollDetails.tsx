          ...
          <div className="space-y-3">
            {poll.options.map(option => (
              <button
                ...
                className="w-full text-left p-4 bg-gray-50 rounded-lg hover:bg-blue-100 border border-gray-200 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-60 disabled:hover:bg-gray-50"
              >
                {option.text}
              </button>
            ))}
